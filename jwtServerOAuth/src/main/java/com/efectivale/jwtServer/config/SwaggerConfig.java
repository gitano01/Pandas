...
public class SwaggerConfig {
		...
		private ApiInfo metaData(){
			...
			return new ApiInfoBuilder()
					.title(ConstantesJwt.Swagger.TITLE)
					.description(ConstantesJwt.Swagger.DESCRIPTION)
					.version(ConstantesJwt.Swagger.VERSION)
					.license(ConstantesJwt.Swagger.LICENSE)
