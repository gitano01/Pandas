...
public class ConexionBD {
	...
	public void  guardaBitacora(String username,String password,  String nombreApi,String response, String ipConsumidor) throws  Exception, SQLException{
	   
		//ir por id del usuario  
			String sql  = "SELECT user_id FROM wsuser WHERE username = "+"'"+ username+"'" + " AND password = " +"'"+enc.encripta(password)+"'";
